...
class Ui_InformaticsPluginDialogBase(object):
    def setupUi(self, InformaticsPluginDialogBase):
        ...
        self.pushbutton_calculate.setGeometry(QtCore.QRect(280, 170, 93, 28))
        ...
        self.tr.setGeometry(QtCore.QRect(270, 20, 221, 191))
        self.tr.setTitle("")
        self.tr.setObjectName("tr")
        self.label_area = QtWidgets.QLabel(self.tr)
        self.label_area.setGeometry(QtCore.QRect(10, 60, 171, 61))
        ...
        self.fore.setGeometry(QtCore.QRect(270, 210, 221, 161))
